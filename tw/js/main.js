var $body = (window.opera) ? (document.compatMode == "CSS1Compat" ? $('html') : $('body')) : $('html,body'),
	...
	postTemp='<div class="video"><a class="thumbnail" href="#"></a><div class="brief"><p class="title"></p><p class="name"></p></div><a class="btn small middle" href="#">更多</a></div>',getNum=6,userData={};
userData["score"]=0;
userData["nowq"]=0;
var text_answer=["此訊息<br>真實性相當高！","此訊息可能會輕微誤導", "此訊息可能含有一些<br>誤導性或不正確的說法","你遇到了陰謀論的<br>可能性相當高！","你遇到了陰謀論的可能性非常高！"];
		...
		$(".qa_List_inner.game .btn").on("click",function(e){
			...
			if(userData["nowq"]==userData["quiz"].length-1){
				if(userData["score"]==100){
					userData["score"]=99;
					$(".qa_List_inner.result .circle_title").html(text_answer[4]);
				}				
...
function setQuizFun(qnum){
	...
	if(qnum==userData["quiz"].length-1){
		$(".qa_List_inner.game .btn").text("看結果");
